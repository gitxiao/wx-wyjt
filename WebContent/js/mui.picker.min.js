...
!function(e, t, i, a) {
    ...
    p.prototype.bindEvent = function() {
        ...
        t = 0,
        i = null;
        e.holder.addEventListener("touchstart",
        function(a) {
            a.preventDefault(),
        ...
        !1),
        e.holder.addEventListener("touchend",
        function(t) {
            t.preventDefault(),
            e.startInertiaScroll(t)
        },
        !1),
        e.holder.addEventListener("touchcancel",
        function(t) {
            t.preventDefault(),
            e.startInertiaScroll(t)
        },
        !1),
        e.holder.addEventListener("touchmove",
        function(a) {
            a.preventDefault();
...
function(e, t) {
    ...
    e.PopPicker = e.Class.extend({
        init: function(a) {
            ...
            n.cancel.addEventListener("tap",
            function(e) {
                n.hide()
            },
            !1),
            n.ok.addEventListener("tap",
            function(e) {
                if (n.callback) {
            ...
            !1),
            n.mask[0].addEventListener("tap",
            function() {
                n.hide()
            },
            !1),
            n._createPicker(),
            n.panel.addEventListener("touchstart",
            function(e) {
                e.preventDefault()
            },
            !1),
            n.panel.addEventListener("touchmove",
            function(e) {
                e.preventDefault()
            },
            !1)
...
function(e, t) {
    ...
    e.DtPicker = e.Class.extend({
        init: function(a) {
            ...
            !1),
            n._create(a),
            n.ui.picker.addEventListener("touchstart",
            function(e) {
                e.preventDefault()
            },
            !1),
            n.ui.picker.addEventListener("touchmove",
            function(e) {
                e.preventDefault()
            },
            !1)
        ...
        getDayNum: function(e, t) {
            var i = this;
            var num = i._inArray([1, 3, 5, 7, 8, 10, 12], t) ? 31 : i._inArray([4, 6, 9, 11], t) ? 30 : i.isLeapYear(e) ? 29 : 28;
            console.log('num = ' + num);
            return num;
        },
        _fill: function(e) {
        ...
        _createDay: function(e) {
            ...
            if (i.customData.d) n = i.customData.d;
				...
				var temp = a.m.picker.getSelectedValue(); 
				if(temp.indexOf('0') == 0){
					temp = temp.substring(1);
				}
            	for (var r = t.getDayNum(parseInt(a.y.picker.getSelectedValue()), parseInt(temp)), s = 1; r >= s; s++) {
	                var c = t._fill(s);
	                n.push({
	                    text: c,
	                    value: c
